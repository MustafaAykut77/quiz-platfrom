const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 w-full h-14 bg-gradient-to-r from-[var(--background)] to-[var(--secondary-bg)] text-[var(--text)]">
      <div className="max-w-6xl mx-auto px-4 h-full flex flex-col md:flex-row justify-between items-center">
